        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-3" role="list" aria-label="Social media links">
              ...
              <a 
                href="#" 
                className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-800 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors"
              ...
              <a 
                href="#" 
                className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-800 hover:bg-red-600 rounded-full flex items-center justify-center transition-colors"
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <p className="text-gray-400 text-[10px] sm:text-xs text-center sm:text-right max-w-md">
